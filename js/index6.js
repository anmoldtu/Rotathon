...
/***/ function(module, exports) {
	...
	var	currencyFormat = {
		...
		'inr': { before: 'Rs ', after: '', divider: ',', n: 2, x: 3 }
	};
	...
	//┘
		...
		var SectionView = Backbone.View.extend(
		{
			...
			insertItems: function ()
			{
				...
				item=document.getElementsByClassName("cart-wrapper")[0].firstElementChild.children[1].firstElementChild.firstElementChild.firstElementChild.firstElementChild.children[1].firstElementChild.firstElementChild.children[1].firstElementChild
...
/***/ function(module, exports) {
	...
	with (obj) {
	__p+='<main role="main">'
	__p += '<!-- <footer class="cp-footer"> -->\n 	<div class="cp-checkout-btn gs-btn popup-trigger btn" id="popup-trigger" >\n		<span class="cp-checkout-ic">\n			<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" style="enable-background:new 0 0 32 32;" xml:space="preserve"><g><path d="M25.4,29H6.6c-1.7,0-3-1.4-2.8-2.9l1.9-13.8C5.9,11,6.6,10,8,10h16c1.4,0,2.1,1,2.3,2.3l1.9,13.8 C28.4,27.6,27.1,29,25.4,29z"/><path d="M10.6,12.7V8.4C10.6,5.4,13,3,16,3h0c3,0,5.4,2.4,5.4,5.4v4.3"/></g></svg>\n		</span>\n		<span class="cp-checkout-label">Checkout</span>\n	</div> \n<!-- </footer> -->';
	__p += '\n </main><div class="overlay" id="overlay"> <div class="overlay-background" id="overlay-background"></div><div class="overlay-content" id="overlay-content"><div class="fa fa-times fa-lg overlay-close" id="overlay-close"></div> <h1 class="main-heading" style="text-align:center">Payment Details</h1><b><p>Please make the payment to the bank account using the below mentioned details and enter the transaction details in the form below. We will verify the payment and complete the process.</p></b><form class="signup-form" method="post" action="#" novalidate="novalidate"> <label for="acc-name"><b>Account Name:-</b> Rotaract Global United Nations</label><br> <label for="acc-num"><b>Account Number:-</b> 37469638016</label><br> <label for="ifsc"><b>IFSC Code:-</b> SBIN0019005</label><br><label for="mon">Money Paid</label> <input id="mon" type="text" name="mpaid" autocomplete="off"/><br> <label for="trans-id">Transaction Number</label><input id="trans-id" type="text" name="tid" autocomplete="off"/><button class="btn btn-outline submit-btn lala" style="display: table; margin: 0 auto"><span>Confirm Details</span></button></form></div></div>';
	}
	return __p
	};
